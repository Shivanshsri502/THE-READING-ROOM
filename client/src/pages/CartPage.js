...
const CartPage = () => {
  ...
  //   try {
  //     const res = await axios.get("https://zsxs.onrender.com/api/v1/product/get-product");
  ...
  const getToken = async () => {
    try {
      const { data } = await axios.get("https://zsxs.onrender.com/api/v1/product/braintree/token");
  ...
  const handlePayment = async () => {
    try {
      ...
      const { data } = await axios.post("https://zsxs.onrender.com/api/v1/product/braintree/payment", {
        nonce,
        cart,
      });
      setLoading(false);
